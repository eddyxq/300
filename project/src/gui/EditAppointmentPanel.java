...
public class EditAppointmentPanel 
{
	...
	public JPanel createPanel(Hospital_Management_System hms)
	{
		...
		lblBackground.setIcon(new ImageIcon(EditAppointmentPanel.class.getResource("/graphics/list_background.png")));
...
//								System.out.println(app.getID()+" "+app.getPName()+" "+jcDoctors.getSelectedItem().toString()+" "+
//										tfDate.getText()+" "+appointmentTime);
								hms.getAppointmentRec().add(new Appointment(app.getID(), app.getPName(), jcDoctors.getSelectedItem().toString(),
										tfDate.getText(), appointmentTime));
								hms.getAppointmentRec().remove(app);
								//display confirmation message
								Object[] options = {"Ok"};
								JOptionPane.showOptionDialog(null, "Appointment updated.", "Success",
