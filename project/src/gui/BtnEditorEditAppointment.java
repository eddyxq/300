 ...
 */
public class BtnEditorEditAppointment extends DefaultCellEditor
{
	...
	public BtnEditorEditAppointment(JTextField txt, Hospital_Management_System hms, Appointment app) 
	{
		super(txt);
		this.hms = hms;
		this.id = id;
